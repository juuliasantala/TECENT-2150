...
# -*- coding: utf-8 -*-
"""
Python sample script for viewing interface IPv6 configuration and state with NETCONF.
...
def view_interface_ipv6(device_ip:str, username:str, password:str,
                        port:int=830, verify:bool=False)->None:
    '''
