...
def create_payload_for_interfaces(template, values):
    ...
    configuration_payload = template.render(interfaces=config["Interfaces"])
...
if __name__ == "__main__":
    ...
    interface_payload = create_payload_for_interfaces(template_file, configuration_file)
